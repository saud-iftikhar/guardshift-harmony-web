        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div>
            <Link to="/" className="text-2xl font-bold flex items-center space-x-2 mb-6">
              <span className="text-blue-400">GuardShift</span>
              <span className="font-light">Master</span>
            </Link>
            <p className="text-gray-400 mb-6">
              Transforming security operations with intelligent scheduling, real-time reporting, and comprehensive management tools.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Knowledge Base</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">GDPR Compliance</a></li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-500 mb-4 md:mb-0">
              © {new Date().getFullYear()} GuardShift Master. All rights reserved.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-sm text-gray-500 hover:text-blue-400 transition-colors">Sitemap</a>
            </div>
          </div>
        </div>
      </div>
